...
import static io.levelops.plugins.commons.plugins.Common.JENKINS_INSTANCE_GUID_FILE;
...
public class JenkinsInstanceGuidServiceTest {
    ...
    public void testCreateOrReturnInstanceGuidExistingDataDirectory() throws IOException {
        ...
        try {
            ...
            io.levelops.plugins.commons.utils.FileUtils.createDirectoryRecursively(dataDirectory);
