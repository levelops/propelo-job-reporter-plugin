...
public class JobRunCodeCoverageXmlResultsService {
    ...
    public void gatherJobRunCodeCoverageXmlResults(Run run, String bullseyeXmlResultPaths, File completeDataDirectory){
        ...
        try {
            LOGGER.log(Level.FINEST, "Levelops code coverage xml post build publisher called");
            ...
            LOGGER.log(Level.SEVERE, "Error in LevelOps code coverage xml PostBuildPublisher perform!", e);
        }
    }
}
